...
import com.hoangsv.lolguide.fragment.CosplayContentFragment;

import org.jsoup.Jsoup;
import org.jsoup.nodes.Document;
import org.jsoup.nodes.Element;

public class WatchCosplayContentActivity extends FragmentActivity {
...
//        mPager.setPageTransformer(true, new ZoomOutPageTransformer());
    ...
    /**
     * A simple pager adapter that represents 5 {@link CosplayContentFragment} objects, in
     * sequence.
     */
    private class ScreenSlidePagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            return CosplayContentFragment.create(position, noidung);
        }
